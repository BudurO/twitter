...
const likes=(idlocal: string | null)=>{
    console.log("clicked")
    
        axios.put(`https://64ee3d821f87218271427022.mockapi.io/twitterpost/${idlocal}`,{
            like:false
        })
        .then((res)=>{
                                    ...
                                    return(
                                        <div key={item.id} className=" border-b-2 border-slate-100  mt-3">
                                            ...
                                            <li className="flex justify-evenly pt-20 mb-4">
                                                        ...
                                                        <div onClick={()=>{ likes(idlocal) }}>
                                                            <svg  xmlns="http://www.w3.org/2000/svg"  fill="currentColor" className="w-6 h-6 fill-current inline-block " viewBox="0 0 16 16"> <path fillRule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" fill="#d93030"></path> </svg>
                                                        </div>
